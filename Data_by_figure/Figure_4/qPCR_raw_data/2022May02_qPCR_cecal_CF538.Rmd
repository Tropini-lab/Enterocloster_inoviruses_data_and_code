...
Efficiency <- (10^(-1/slope)-1)*100
  ...
  ggplot(aes(x = Copy_number, y = Cq)) +
    ...
    theme_bw() +
    labs(x = "Inovirus Copies/Rxn", y = "Cq", title = "C. clostridioforme 538 Inovirus Standard Curve")
...
CF538_lm <- lm(Cq ~ log_copy_number, data = dat_bolt)
...
Efficiency <- (10^(-1/slope)-1)*100
  ...
  ggplot(aes(x = Copy_number, y = Cq)) +
    ...
    theme_bw() +
    labs(x = "Inovirus Copies/Rxn", y = "Cq", title = "C. clostridioforme 538 gDNA Standard Curve")
