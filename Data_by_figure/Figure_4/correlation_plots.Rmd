...
dat$Bacteria <- factor(dat$Bacteria, levels = c("Clostridium bolteae",
                                                "Clostridium clostridioforme 538",
                                                "Clostridium clostridioforme 455",
...
```{r}
dat_bolt <- dat %>% filter(Bacteria == "Clostridium bolteae")
...
res
```
## 2) C. clostridioforme 538 assumptions and correlation test
```{r}
dat_CF538 <- dat %>% filter(Bacteria == "Clostridium clostridioforme 538")

# Shapiro-Wilk normality test for Growth Rate
shapiro.test(dat_CF538$Growth_Rate) 
# Shapiro-Wilk normality test Inovirus copy number
shapiro.test(dat_CF538$`Inovirus pI copies/mL supernatant`)

# We need to use spearman, since once of the variables is not normally distributed!!
res <- cor.test(dat_CF538$Growth_Rate, dat_CF538$`Inovirus pI copies/mL supernatant`, method = "spearman")
res
```

## 3) C. clostridioforme 455 assumptions and correlation test
```{r}
dat_CF455 <- dat %>% filter(Bacteria == "Clostridium clostridioforme 455")

# Shapiro-Wilk normality test for Growth Rate
shapiro.test(dat_CF455$Growth_Rate) 
# Shapiro-Wilk normality test Inovirus copy number
shapiro.test(dat_CF455$`Inovirus pI copies/mL supernatant`)

# We need to use spearman, since once of the variables is not normally distributed!!
res <- cor.test(dat_CF455$Growth_Rate, dat_CF455$`Inovirus pI copies/mL supernatant`, method = "spearman")
res
```
## 4) C. citroniae assumptions and correlation test
```{r}
dat_citroniae <- dat %>% filter(Bacteria == "Clostridium citroniae")
...
shapiro.test(dat_CF538$Growth_Rate) 
# Shapiro-Wilk normality test Inovirus copy number
shapiro.test(dat_CF538$`Biofilm Formation OD 595`)

# We need to use spearman, since once of the variables is not normally distributed!!
res <- cor.test(dat_CF538$Growth_Rate, dat_CF538$`Biofilm Formation OD 595`, method = "spearman")
res
```
...
shapiro.test(dat_CF455$Growth_Rate) 
# Shapiro-Wilk normality test Inovirus copy number
shapiro.test(dat_CF455$`Biofilm Formation OD 595`)

# We need to use spearman, since once of the variables is not normally distributed!!
res <- cor.test(dat_CF455$Growth_Rate, dat_CF455$`Biofilm Formation OD 595`, method = "spearman")
res
```
## 4) C. citroniae assumptions and correlation test
```{r}
